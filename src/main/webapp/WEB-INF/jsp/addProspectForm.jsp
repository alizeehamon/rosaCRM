            ...
            <div class="row text-start">
                ...
                <div class="col-12 mb-3">
                    <div class="form-group">
                        ...
                        <input id="adress1" name="adress1" class="form-control">
                    </div>
                </div>
                <div class="col-12 mb-3">
                    <div class="form-group">
                        <label for="adress2" class="form-label">Address:Line2</label>
                        <input id="adress2" name="adress2" class="form-control">
                    </div>
                </div>
                <div class="col-6 mb-3">
                    <div class="form-group">
