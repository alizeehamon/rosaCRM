...
<div class="modal fade" id="setReminder${prospect.id}">
                        ...
                        <div class="col-12 mb-3">
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input id="relanceDuration" required min="1" max="30" name="relanceDuration" class="form-control" value="${requestScope.prospect.relanceDuration}">
                                </div>
                            </div>
